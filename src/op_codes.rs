...
lazy_static! {
  pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
    ...
    OpCode::new(0x0A, "ASL", 1, 2, AddressingMode::None), // ASL Accumulator
    ...
    OpCode::new(0x6C, "JMP", 1, 2, AddressingMode::None),

    OpCode::new(0x20, "JSR", 3, 6, AddressingMode::Absolute),

    OpCode::new(0x4A, "LSR", 1, 2, AddressingMode::None), // LSR Accumulator
